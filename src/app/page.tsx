...
export default function Home() {
  ...
  return (
    <div
      className={` max-w-5xl p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 top-0 bottom-0 left-0 right-0 m-auto absolute mt-10 mb-10 text-center`}
    >
